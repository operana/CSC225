...
Version 2.0: trying to simplify switch case by only assigning values to amount caps within each case, but putting the if statements/conditional code after in one block of code. 
*/

 import java.util.Scanner;

 public class ComputeTaxCopy {
    public static void main(String[] args) {
        ...
        //compute tax based on the filing status (amount caps assigned from the switch case)
        ...
        //display tax to user
        System.out.println("Based on your filing status and taxable income, your income tax is: $" + tax);
